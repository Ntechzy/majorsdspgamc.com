        ...
        <div className="w-full flex text-white text-[10px] sm:text-sm ">
            ...
            <div className="bg-[#f8a713] px-6 py-2 flex items-center space-x-3 w-[40%]">
                ...
                <div className="flex items-center space-x-2">
                    <a href="https://www.facebook.com/share/14EWEzodCgj/" className="bg-[#0f6b5b] p-1.5 rounded-full" target='_blank'><FaFacebookF /></a>
                    <a href="https://www.instagram.com/majorsdsinghpg/" className="bg-[#0f6b5b] p-1.5 rounded-full" target='_blank'><FaInstagram /></a>
                    <a href="https://wa.me/917300864280" rel="noopener noreferrer" className="bg-[#0f6b5b] p-1.5 rounded-full" target='_blank'><FaWhatsapp /></a>
                    <a href="https://www.youtube.com/@majorsdsinghp.g.ayurvedicm4085" className="bg-[#0f6b5b] p-1.5 rounded-full" target='_blank'><FaYoutube /></a>
                </div>
            </div>
