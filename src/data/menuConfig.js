...
export const menuConfig = {
  ncism: {
    ...
    icon: Activity,
    items: [
      { label: "Teaching Staff", icon: GraduationCap, type: "file", api: "/teaching-staff" },
      { label: "Intake Capacity", icon: ClipboardList, type: "table", api: "/intake-capacity" },
      { label: "Non Teaching Staff", icon: Users, type: "file", api: "/non-teaching" },
      { label: "Student Details", icon: FileText, type: "file", api: "/students" },
      { label: "Research Publication", icon: BookOpen, type: "table", api: "/research" },
      { label: "Conferences and Academic Activities", icon: Presentation, type: "file", api: "/conferences" },
