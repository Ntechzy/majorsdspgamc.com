const courses = [
  {
    ...
    description:
      "A professional 4.5‑year degree providing comprehensive knowledge of Ayurvedic medicine, diagnostics, and patient care.",
    duration: "4.5 years",
    seats: 100,
  ...
  },
  {
    ...
    description:
      "A diploma/degree program (typically 3 years) training students in patient care, herbal preparations, Panchakarma support, and holistic nursing.",
    duration: "3 years",
    seats: 50,
  ...
  },
  {
    ...
    description:
      "A 2‑year diploma course focused on classical Ayurvedic formulations, pharmacognosy, medicine preparation, and dispensing.",
    duration: "2 year",
    seats: 50,
